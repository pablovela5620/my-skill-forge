...
- Pick a named color strategy:
  - Restrained: tinted neutrals and one accent. Default for reports, plans, reviews, tools.
...
Every control needs hover, focus-visible, active, and disabled states when applicable. Touch targets should be at least 44px on mobile.
